...
%         %2. contribui para a falha a esquerda
%         A(nx + 1,i) = A(nx + 1,i) - Tvol_esq;
%         A(nx + 1,i + 1) = A(nx + 1,i + 1) - Tvol_dir;
%         A(nx + 1,nx + 1) = A(nx + 1,nx + 1) - Tfalha_esq;
...
%         %4. contribui para a falha a direita
%         A(nx + 2,i + 1) = A(nx + 2,i + 1) - Tvol_dir;
%         A(nx + 2,i) = A(nx + 2,i) - Tvol_esq;
%         A(nx + 2,nx + 2) = A(nx + 2,nx + 2) - Tfalha_dir;

        %Equaçoes para a falha (fluxo a esuqerda)
        Tbc_esq = -Krocha(i)/dx;
        %Contribui
