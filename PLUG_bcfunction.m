...
global coord bcflag numcase bcflagc u0;
...
%throughout the function
    ...
    case 421
        ...
        elseif y>delta
            bcattrib = 11-h1*y + cte;
            
        else
            bcattrib = 6.5-h2*y + cte;
    ...
    case 423
        ...
        elseif y>delta
            bcattrib = 11 - h1*y + sin(x)*cos(y) + cte;
            
        else
            bcattrib = 6.5 - h2*y + sin(x)*cos(y) + cte;
    ...
    case 424
        ...
        elseif y>delta
            bcattrib = - h1*y + 100*sin(x)*cos(y) +11+ cte;
            
        else
            bcattrib = - h2*y + 100*sin(x)*cos(y) +6.5+ cte;
