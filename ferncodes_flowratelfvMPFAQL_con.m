function [flowrate,flowresult]=ferncodes_flowratelfvMPFAQL_con(parameter,weightDMP,pinterp,p)
...
for ifacont=1:bedgesize
    ...
    if bedge(ifacont,7)>200
        ...
        r=find(x==1);
        flowrate(ifacont,1)=-normcont*bcflagc(r,2);
    else
...
for iface=1:inedgesize
    ...
    flowrate(ifactual,1)=(murel*fluxesq-mulef*fluxdireit);
