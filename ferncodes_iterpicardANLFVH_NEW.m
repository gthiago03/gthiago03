function [p,flowrate,flowresult]=ferncodes_iterpicardANLFVH(M_old,RHS_old,...
    parameter,p_old,nflagface,wells,mobility,weightDMP,w,s,nflagno,contnorm,gravelem,gravface)
...
[p,erro,iter]=ferncodes_andersonacc2(p_old,1e-6,parameter,w,s,...
    nflagface,weightDMP,wells,mobility,R0,contnorm,gravelem,gravface);
